...
Verified locally: SDK 54 Expo Go project structure, TypeScript, Expo lint, static web export, 390×844 and 393×852 layouts, and a real physical iPhone launch over LAN. The device launch proves network/runtime compatibility, not complete UX quality; device-specific issues still require screenshots and focused fixes. No iOS binary or installer has been produced.
